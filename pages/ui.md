...
UI is a class that combines 2 sub-classes [GUI*](https://github.com/a4aran/IlluEngine/wiki/GUI) and [HUD](https://github.com/a4aran/IlluEngine/wiki/HUD).
...
[GUI*](https://github.com/a4aran/IlluEngine/wiki/GUI) and [HUD](https://github.com/a4aran/IlluEngine/wiki/HUD) are privatted so the only way to create objects of thier sub-classes is to use **creator methods** (they start with `new`).
